...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_deploy_aws-ebs-csi-driver"></a> [deploy\_aws-ebs-csi-driver](#module\_deploy\_aws-ebs-csi-driver) | ./deploy | n/a |
| <a name="module_deploy_aws-efs-csi-driver"></a> [deploy\_aws-efs-csi-driver](#module\_deploy\_aws-efs-csi-driver) | ./deploy | n/a |
| <a name="module_deploy_aws-load-balancer-controller"></a> [deploy\_aws-load-balancer-controller](#module\_deploy\_aws-load-balancer-controller) | ./deploy | n/a |
| <a name="module_deploy_cert-manager"></a> [deploy\_cert-manager](#module\_deploy\_cert-manager) | ./deploy | n/a |
| <a name="module_deploy_cluster-autoscaler"></a> [deploy\_cluster-autoscaler](#module\_deploy\_cluster-autoscaler) | ./deploy | n/a |
| <a name="module_deploy_csi-external-snapshotter"></a> [deploy\_csi-external-snapshotter](#module\_deploy\_csi-external-snapshotter) | ./deploy | n/a |
| <a name="module_deploy_dashboard"></a> [deploy\_dashboard](#module\_deploy\_dashboard) | ./deploy | n/a |
| <a name="module_deploy_dex"></a> [deploy\_dex](#module\_deploy\_dex) | ./deploy | n/a |
| <a name="module_deploy_dex-k8s-authenticator"></a> [deploy\_dex-k8s-authenticator](#module\_deploy\_dex-k8s-authenticator) | ./deploy | n/a |
| <a name="module_deploy_external-dns"></a> [deploy\_external-dns](#module\_deploy\_external-dns) | ./deploy | n/a |
| <a name="module_deploy_goldilocks"></a> [deploy\_goldilocks](#module\_deploy\_goldilocks) | ./deploy | n/a |
| <a name="module_deploy_ingress-nginx"></a> [deploy\_ingress-nginx](#module\_deploy\_ingress-nginx) | ./deploy | n/a |
| <a name="module_deploy_ingress-nginx-internal"></a> [deploy\_ingress-nginx-internal](#module\_deploy\_ingress-nginx-internal) | ./deploy | n/a |
| <a name="module_deploy_kube-prometheus-stack"></a> [deploy\_kube-prometheus-stack](#module\_deploy\_kube-prometheus-stack) | ./deploy | n/a |
...
| <a name="module_deploy_vpa"></a> [deploy\_vpa](#module\_deploy\_vpa) | ./deploy | n/a |
...
| [kubectl_manifest.aws-efs-csi-driver_vsc](https://registry.terraform.io/providers/alekc/kubectl/latest/docs/resources/manifest) | resource |
...
| [kubectl_manifest.sync](https://registry.terraform.io/providers/alekc/kubectl/latest/docs/resources/manifest) | resource |
...
| [kubernetes_network_policy.reloader_allow_monitoring](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/docs/resources/network_policy) | resource |
...
| [null_resource.cert-manager-kustomize-prepare](https://registry.terraform.io/providers/hashicorp/null/latest/docs/resources/resource) | resource |
...
| [kubectl_file_documents.apply](https://registry.terraform.io/providers/alekc/kubectl/latest/docs/data-sources/file_documents) | data source |
...
| [kubectl_file_documents.sync](https://registry.terraform.io/providers/alekc/kubectl/latest/docs/data-sources/file_documents) | data source |
